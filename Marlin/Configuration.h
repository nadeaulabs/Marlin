...
#define STRING_CONFIG_H_AUTHOR "(Lee Wilkinson QQ-S-Pro SKR 1.4 Probe Pin pwrdet ABL tmc2209)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Nadeaulabs FLSUN QQ-S Pro"
...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 280.56        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 358.31             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -0.40, -0.70 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 141.28              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.19, 0.02, -0.21 } // Get these values from G33 auto calibrate
